...
const MainProject = () => {
  ...
  // Filtrer les projets pour afficher seulement les projets 7, 8 et 9
  const filteredProjects = projectData.projects.filter(project => [7, 8, 9].includes(project.id));
      ...
      {filteredProjects.map((project) => (
        ...
        >
          ...
          <div className="project-details">
            ...
            {project.linkGithub && <p><a href={project.linkGithub} target="_blank" rel="noopener noreferrer">GitHub</a></p>}
            {project.linkgithubPages && <p><a href={project.linkgithubPages} target="_blank" rel="noopener noreferrer">GitHub Pages</a></p>}
          </div>
          </div>
      ))}
        </div>
